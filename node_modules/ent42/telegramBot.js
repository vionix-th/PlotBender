...
class Ent42TelegramBot {
  ...
  uniqueAiId(msg) {
    ...
    return { chatId: msg.chat.id, aiId };
  }

  uniqueAiForChat(msg) {
    const {chatId, aiId} = this.uniqueAiId(msg);
